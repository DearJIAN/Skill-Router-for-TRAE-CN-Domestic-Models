...
## V3.1 Hard-Gate Patch / V3.1 硬闸门补丁
...
只有在进入某阶段之前，重新输出该阶段 Router Pass + 对应 V3.1-n marker，才算该阶段真的重新路由。
```
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-<n>
当前阶段：<stage>
...
- Before code edits, MUST run `ROUTER_CHECKPOINT_3_IMPLEMENTATION` and output `...V3.1-4`.
- Before polish/review, MUST run `ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH` and output `...V3.1-5`.
- Before tests/browser QA/final verification, MUST run `ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION` and output `...V3.1-6`.
- Before docs/handoff/final context summary, MUST run `ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF` and output `...V3.1-7` when relevant.
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-4
当前阶段：实现阶段
本阶段实际调用 / 使用 skills：
...
- If only `...V3.1-1` appears, the agent MUST NOT claim multi-stage routing happened.
- If implementation happened but `...V3.1-4` never appeared before implementation, mark it as a violation.
- If QA/testing/browser checks happened but `...V3.1-6` never appeared before QA, mark it as a violation.
...
```text
V3.1-1: task map
V3.1-3: planning/design
V3.1-4: implementation
V3.1-5: review/polish
V3.1-6: QA/verification
```

If the complex task includes docs, handoff, or skill work, also use:

```text
V3.1-7: documentation/handoff
```
...
## V3.1 Todo-Bound Dynamic Gate Patch / V3 任务列表绑定动态闸门补丁
...
- Todo item: <exact router gate todo title>
  ...
  Marker: <SKILL_ROUTER_APPLIED ... V3.1-n OR skipped/violation>
...
V3.1 is middle-high aggressive, but not template-driven.
...
## V3.1 Resume-Safe Router Patch / V3.1 防回退续跑补丁
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-6
...
1. Run a real review/polish router gate and output `...V3.1-5`.
...
### 11. V3.1 recommended user-facing instruction / V3.1 推荐用户提示词

When the user wants strict multi-stage router behavior, the agent should understand this compact instruction:

```text
请使用 skill-router 的 V3.1 Resume-Safe Todo-Bound Hard-Gated 模式。
...
V3.1 uses **stage-specific verification markers**.
...
```text
ROUTER_20260512_CN_GSTACK——V3.1
```
...
|---|---|---|
| `ROUTER_CHECKPOINT_0_TASK_MAP` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-1` | Initial task mapping, complexity classification, candidate pool, and first-stage plan were produced. |
| `ROUTER_CHECKPOINT_1_DISCOVERY` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-2` | Discovery / requirement-stage routing was actually run. |
| `ROUTER_CHECKPOINT_2_PLANNING_OR_DESIGN` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-3` | Planning, architecture, or design-stage routing was actually run. |
| `ROUTER_CHECKPOINT_3_IMPLEMENTATION` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-4` | Implementation-stage routing was actually run. |
| `ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-5` | Review, critique, polish, or completeness-stage routing was actually run. |
| `ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-6` | QA, testing, browser verification, or regression-stage routing was actually run. |
| `ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-7` | Documentation, handoff, issue, PRD, or final context-preservation routing was actually run. |
...
StageMarker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-<n>
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-<n>
```
...
```text
Router Pass: ROUTER_CHECKPOINT_0_TASK_MAP
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-1
任务类型：<type>
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-4
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-5
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-6
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-7
```
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-3
当前阶段：设计 / 架构 / UI 方向
...
阶段调用台账 / Stage Marker Ledger:
- ROUTER_CHECKPOINT_0_TASK_MAP
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-1
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_1_DISCOVERY
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-2 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_2_PLANNING_OR_DESIGN
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-3 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_3_IMPLEMENTATION
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-4 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-5 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-6 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-7 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
...
```text
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3.1-1
```
