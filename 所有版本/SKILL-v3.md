...
只有在进入某阶段之前，重新输出该阶段 Router Pass + 对应 V3-n marker，才算该阶段真的重新路由。
```
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-<n>
当前阶段：<stage>
...
- Before code edits, MUST run `ROUTER_CHECKPOINT_3_IMPLEMENTATION` and output `...V3-4`.
- Before polish/review, MUST run `ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH` and output `...V3-5`.
- Before tests/browser QA/final verification, MUST run `ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION` and output `...V3-6`.
- Before docs/handoff/final context summary, MUST run `ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF` and output `...V3-7` when relevant.
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-4
当前阶段：实现阶段
本阶段实际调用 / 使用 skills：
...
- If only `...V3-1` appears, the agent MUST NOT claim multi-stage routing happened.
- If implementation happened but `...V3-4` never appeared before implementation, mark it as a violation.
- If QA/testing/browser checks happened but `...V3-6` never appeared before QA, mark it as a violation.
...
```text
V3-1: task map
V3-3: planning/design
V3-4: implementation
V3-5: review/polish
V3-6: QA/verification
```

If the complex task includes docs, handoff, or skill work, also use:

```text
V3-7: documentation/handoff
```
...
## V3 Todo-Bound Dynamic Gate Patch / V3 任务列表绑定动态闸门补丁
...
- Todo item: <exact router gate todo title>
  ...
  Marker: <SKILL_ROUTER_APPLIED ... V3-n OR skipped/violation>
...
V3 is middle-high aggressive, but not template-driven.
...
V3 uses **stage-specific verification markers**.
...
|---|---|---|
| `ROUTER_CHECKPOINT_0_TASK_MAP` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-1` | Initial task mapping, complexity classification, candidate pool, and first-stage plan were produced. |
| `ROUTER_CHECKPOINT_1_DISCOVERY` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-2` | Discovery / requirement-stage routing was actually run. |
| `ROUTER_CHECKPOINT_2_PLANNING_OR_DESIGN` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-3` | Planning, architecture, or design-stage routing was actually run. |
| `ROUTER_CHECKPOINT_3_IMPLEMENTATION` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-4` | Implementation-stage routing was actually run. |
| `ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-5` | Review, critique, polish, or completeness-stage routing was actually run. |
| `ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-6` | QA, testing, browser verification, or regression-stage routing was actually run. |
| `ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF` | `SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-7` | Documentation, handoff, issue, PRD, or final context-preservation routing was actually run. |
...
StageMarker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-<n>
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-<n>
```
...
```text
Router Pass: ROUTER_CHECKPOINT_0_TASK_MAP
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-1
任务类型：<type>
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-4
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-5
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-6
```
...
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-7
```
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-3
当前阶段：设计 / 架构 / UI 方向
...
Stage marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-6
当前阶段：QA / 验证
...
阶段调用台账 / Stage Marker Ledger:
- ROUTER_CHECKPOINT_0_TASK_MAP
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-1
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_1_DISCOVERY
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-2 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_2_PLANNING_OR_DESIGN
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-3 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_3_IMPLEMENTATION
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-4 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_4_REVIEW_OR_POLISH
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-5 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_5_QA_OR_VERIFICATION
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-6 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
- ROUTER_CHECKPOINT_6_DOCUMENTATION_OR_HANDOFF
  - Marker: SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-7 OR Stage skipped: <reason>
  - 已使用 / 尝试使用 skills: <skills actually used in this stage>
  - 阶段目标: <goal>
  - 验证方式: <evidence or notes>
...
```text
SKILL_ROUTER_APPLIED: ROUTER_20260512_CN_GSTACK——V3-1
```
